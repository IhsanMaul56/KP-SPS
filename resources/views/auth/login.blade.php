...
@section('content')
<div class="container-fluid p-5" style="background-color:#16498c; height: 479px;">
    <div class="row">
        ...
        <div class="col-md-4">
            <img src="{{URL::asset('/img/saly10@2x.png')}}" alt="logo smk" height="300" width="300" style="margin-left: -43; margin-bottom: -123%;">
        </div>
    </div>
    <div class="row">
        <div class="col-md-4">
            <div class="card" style="position: absolute; z-index: 2; margin-right: 57px; width: 455px; height: 586px; left: 924px; bottom: 191px;">
                <div class="card-body">
...
<div class="container-fluid">
    <img src="{{URL::asset('/img/pemanis.png')}}" class="img-fluid mb-3" alt="logo smk" width="64%" style="margin-top: 60px;">
</div>
@endsection