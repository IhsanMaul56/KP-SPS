<!-- Modal -->
<div wire:ignore.self class="modal fade" id="DeleteDataGuruM" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 325px;">
        <div class="modal-content" style="border-radius: 12px;">
            <div class="modal-header">
                <h5 class="modal-title w-100 text-center titlemodal-style fw-bold" id="deleteDataModalLabel">HAPUS GURU</h5>
            </div>
            <div class="modal-body">
                ...
                <div class="modal-footer justify-content-center" style="border-top: unset !important">
                    ...
                    <button class="btn btn-danger" wire:click="deleteGuru">Hapus</button>
                </div>
            </div>
        </div>
    </div>
