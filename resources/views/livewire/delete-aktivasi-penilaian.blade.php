<!-- Modal -->
<div wire:ignore.self  class="modal fade" id="DeletePeriode" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="deleteDataModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width:325px;">
        <div class="modal-content" style="border-radius: 12px;">
            <div class="modal-header">
                <h5 class="modal-title w-100 text-center titlemodal-style fw-bold" id="deleteDataModalLabel">HAPUS PERIODE</h5>
            </div>
