    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <input type="text" class="form-control @error('formatif_akhir') is-invalid @enderror" wire:model="formatif_akhir" name="formatif_akhir" placeholder="Masukkan Persentase Nilai Formatif" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <input type="text" class="form-control @error('sumatif_uts') is-invalid @enderror" wire:model="sumatif_uts" name="sumatif_uts" placeholder="Masukkan Persentase UTS" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        @error('sumatif_uts')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-2">
                    <div class="col">
                        <input type="text" class="form-control @error('sumatif_uas') is-invalid @enderror" wire:model="sumatif_uas" name="sumatif_uas" placeholder="Masukkan Persentase UAS" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        @error('sumatif_uas')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row mt-3">
                    <div class="col">
                        <b class="text-danger">*</b><small style="color: grey">Note: Total Persentase Harus 100</small>
                    </div>
                </div>
            </div>
