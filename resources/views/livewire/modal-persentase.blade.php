    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <input type="text" class="form-control" name="" id="" placeholder="Persentase Nilai Formatif">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                ...
                <div class="row mb-2">
                    <div class="col">
                        <input type="text" class="form-control" name="" id="" placeholder="Persentase UTS">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <input type="text" class="form-control" name="" id="" placeholder="Persentase UAS">
                    </div>
                </div>
            </div> 
