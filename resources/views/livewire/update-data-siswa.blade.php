                                        ...
                                        <div class="col-3">
                                            <div class="input-group">
                                                <input id="nis" type="text"
                                                    ...
                                                    wire:model="nis" name="nis" value="{{ $siswa->nis }}">
                                                @error('nis')
                                        ...
                                        <div class="col-3" style="width: 12%">
                                            <div class="input-group">
                                                <input id="rt" type="text"
                                                    ...
                                                    wire:model="rt" name="rt" value="{{ $siswa->rt }}">
                                                @error('rt')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-3" style="width: 13%">
                                            <div class="input-group">
                                                <input id="rw" type="text"
                                                    ...
                                                    wire:model="rw" name="rw" value="{{ $siswa->rw }}">
                                                @error('rw')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-3" style="width: 12%">
                                            <div class="input-group">
                                                <input id="rt_ortu" type="text"
                                                    ...
                                                    style="border-color: rgba(168, 168, 168, 1);" placeholder="RT"
                                                    wire:model="rt_ortu" name="rt_ortu" value="{{ $siswa->rt_ortu }}">
                                                @error('rt_ortu')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-3" style="width: 13%">
                                            <div class="input-group">
                                                <input id="rw_ortu" type="text"
                                                    ...
                                                    style="border-color: rgba(168, 168, 168, 1);" placeholder="RW"
                                                    wire:model="rw_ortu" name="rw_ortu" value="{{ $siswa->rw_ortu }}">
                                                @error('rw_ortu')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
