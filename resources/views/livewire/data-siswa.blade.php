            ...
            <tbody>
                @foreach ($siswa as $item)
                    <tr class="text-center">
                        ...
                        <td>{{ $item->no_hp }}</td>
                        <td>
                            <a href="{{ route('update-data-siswa', ['nis' => $item->nis]) }}"
                                wire:click="viewUpdate('{{ $item->nis }}')" class="btn btn-warning ling">
                                <i class="bi bi-pencil-square text-white"></i>
                            </a>
                            <button wire:click="showDelete('{{ $item->nis }}')" data-bs-toggle="modal"
                                class="btn btn-danger" data-bs-target="#DeleteDataSiswa">
